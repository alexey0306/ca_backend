...
Revision ID: 702de3a8fe9d
Revises: 
Create Date: 2017-12-20 10:08:10.844488
...
def upgrade():
    ...
    op.create_index(op.f('ix_administrators_name'), 'administrators', ['name'], unique=False)
    op.create_table('ca',
    sa.Column('id', sa.Integer(), nullable=False),
